...
def int_list_validator(
    sep: str = ..., message: StrOrPromise | None = ..., code: str = ..., allow_negative: bool = ...
) -> RegexValidator: ...
...
class BaseValidator:
    ...
    code: str
    limit_value: Any
    def __init__(self, limit_value: Any, message: StrOrPromise | None = ...) -> None: ...
    def __call__(self, value: Any) -> None: ...
...
class ProhibitNullCharactersValidator:
    message: StrOrPromise
    code: str
    def __init__(self, message: StrOrPromise | None = ..., code: str | None = ...) -> None: ...
    def __call__(self, value: Any) -> None: ...
